...
import torch
import torchaudio
from BEATs import BEATs as RawBEATs
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='Path to BEATs checkpoint .pt',
    )
    parser.add_argument(
        '--wav',
        type=str,
        default='/inspire/hdd/project/embodied-multimodality/public/hfchen/cargoflow/cargoflow/work_dirs/debug/audios/2_0.wav',
